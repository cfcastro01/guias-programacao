...
Projeto local de cursos e projetos práticos para quem está começando a programar. A versão atual apresenta o curso **JavaScript Iniciante**, com um sumário provisório e as duas primeiras aulas.
...
Esta é apenas a estrutura inicial. As Aulas 1 e 2 estão na página principal para facilitar o desenvolvimento neste começo. Quando houver mais conteúdo, cada curso ou projeto poderá receber suas próprias páginas dentro da pasta correspondente.
